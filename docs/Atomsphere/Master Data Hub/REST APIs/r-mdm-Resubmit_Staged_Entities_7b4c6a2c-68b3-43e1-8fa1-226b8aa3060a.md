...
-   400 \(Bad Request\) The authenticating user does not have the **API Access** privilege and the **Resubmit Staged Data** entitlement required for this operation. Sample response body:
